...
Sim, elas são logicamente equivalentes já que seguem a regra da distributividade
...
Sim, elas também são logicamentes equivalentes
...
As cláusulas 1 e 3 são logicamente equivalentes entre si; a cláusula 2 não é equivalente a nenhuma das outras, pois trocou incorretamente o AND por OR ao aplicar a negação.
